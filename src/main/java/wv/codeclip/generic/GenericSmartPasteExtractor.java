// ===== GenericSmartPasteExtractor.java =====
...
/**
 * Generic mode's own Smart Paste extractor — scans arbitrary clipboard text
 * for, in document order:
 *   - @@PATCH ... @@END blocks
 *   - #@FileStart: <path> ... #@FileEnd blocks (whole-file replacements)
 * Everything else is discarded. Identical logic to
 * wv.codeclip.html.HtmlSmartPasteExtractor.
 */
public final class GenericSmartPasteExtractor {
    ...
    public GenericSmartPasteExtractor(String text) {
