...
/**
 * Confirmation dialog for Generic mode's fuzzy @@FIND matches. Mirrors
 * wv.codeclip.html.FuzzyMatchDialog exactly, kept as a separate small class
 * per-mode rather than shared, consistent with the rest of Generic mode.
 */
public class FuzzyMatchDialogGeneric extends JDialog {

    public enum Decision { ACCEPT, REJECT }

    private Decision result = Decision.REJECT;

    public FuzzyMatchDialogGeneric(JFrame parent, String fileName, double similarityPercent,
    ...
    public static Decision show(JFrame parent, String fileName, double similarityPercent,
        ...
        Runnable r = () -> {
            FuzzyMatchDialogGeneric dlg = new FuzzyMatchDialogGeneric(parent, fileName, similarityPercent,
